# Geekbrains 
### [Базы данных](https://geekbrains.ru/courses/690)
Длительность 1 месяц. Количество занятий - 12 уроков
...
#### Курс состоит из 20 интенсивных видеоуроков (по 10 минут), где представлены все этапы проектирования баз данных с использованием языка запросов SQL. 
Количество занятий - 20 уроков
